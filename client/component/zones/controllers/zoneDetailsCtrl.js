angular.module("gnarrly").controller("ZoneDetailsCtrl", ['$scope', '$stateParams', '$meteor', '$filter',
  function($scope, $stateParams, $meteor, $filter){

    $scope.party = $meteor.object(Zones, $stateParams.zoneId);
    $scope.images = $meteor.collectionFS(Images, false).subscribe('images');

    var subscriptionHandle;
    $meteor.subscribe('zones').then(function(handle) {
